<?php
/*-----------------------
Autor: Luis Daniel Arochi Rincon
ing.arochi@gmail.com
2019
	 ...
	 if (empty($_POST['nNombre'])){
		...
		if ($_FILES['archivo']["error"] > 0){
		  echo "Error: " . $_FILES['archivo']['error'] . "<br>";
		 	...
		 	move_uploaded_file($_FILES['archivo']['tmp_name'], 'img/'.$_FILES['archivo']['nombres']);
		 	$ruta='img/'.$_FILES['archivo']['nombres'];
		 }
		...
		$sql="INSERT INTO proveedores (id_proveedor, nombre, calle, noExterior, noInterior, colonia, cp, pais, estado, municio, responsable, movil, mail1, RFC, telefono1, telefono2, logo, eliminado) 
			 VALUES (".$nombres."', '".$nombre."','".$calle."','".$exterior."', '".$interior."', '".$colonia."', '".$cp."', '".$pais."', '".$estado."', '".$municipio."' , '".$responsable."', '".$movil."', '".$mail1."', '".$mail2."', '".$tel1."', '".$tel2."', '".$ruta."', '0'	)";
